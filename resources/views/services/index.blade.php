...
<div class="flex flex-col justify-center items-center w-screen px-5 md:px-24">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
        <div class="feature-box border-green-300 bg-green-50 relative" data-aos="fade-up" data-aos-duration="1500">
            ...
            <!-- <a href="{{route('selftest.index')}}" class="text-sm rounded-full mt-4 bg-transparent border py-1 px-3 text-green-600 hover:border-green-100 hover:bg-green-600 hover:text-slate-50">Get Started</a> -->
            <a href="{{route('selftest.index')}}" class="text-sm rounded-full mt-4 btn-green">Start Now</a>
        </div>
