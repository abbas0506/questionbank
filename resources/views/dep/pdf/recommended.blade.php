    ...
    <footer class="footer">
        <table class="mt-8 w-full">
            <tbody>
                ...
                <tr class="text-xs text-center ">
                    <td colspan="3" style="color:#222;font-size:10px">List of Recommended Applications, Part I, Session {{$session->title()}}, {{now()}}</td>
                </tr>
            </tbody>
        </table>
    </footer>
    ...
    <main>
        <div class="container">
            ...
            <div class="w-1/2 mx-auto">
                <div class="relative">
                    <div class="absolute"><img alt="logo" src="{{public_path('/images/logo/main_logo.png')}}" class="w-16"></div>
                </div>
                <table class="w-full">
                    <tbody>
                        <tr>
                            <td class="text-center text-xl font-bold">List of Recommended Applications</td>
                        </tr>
                        <tr>
