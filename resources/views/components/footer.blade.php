<div class="w-screen mt-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 bg-slate-800 gap-6 md:gap-x-20 p-4 md:px-24 mt-12">
        <div>
            <h3 class="text-base text-orange-300">Exam System</h3>
            <p class="text-sm text-slate-400">Provides you an easy and user friendly interface for students assessment and track their progress round the year</p>
        </div>
        <div>
