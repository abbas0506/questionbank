            ...
            <div class="flex flex-col bg-orange-50 border border-orange-200" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-sine">
                ...
                <div class="p-5">
                    ...
                    <ul class="list-disc list-inside leading-relaxed">
                        ...
                        <li>Fully customized papers in .pdf</li>
                        <li>Font specification, page layout</li>
                        <li>PDF format</li>
                        <li>Multiple papers per sheet</li>
                        <li>Class formation</li>
                        <li>Quiz link sharing on whatsapp</li>
                        <li>Statistical & graphical analysis</li>
                    </ul>
            ...
            <div class="flex flex-col bg-blue-50 border border-blue-200" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-sine">
                ...
                <div class="p-5">
                    ...
                    <ul class="list-disc list-inside leading-relaxed">
                        ...
                        <li>Upto 50 teachers accounts allowed</li>
                        <li>Subject allocation / time table</li>
                        <li>Datesheet generation</li>
                        <li>Exam data feeding, once for ever</li>
                        <li>Individual class analysis </li>
                        <li>Comparative analysis of classes</li>
                    </ul>
